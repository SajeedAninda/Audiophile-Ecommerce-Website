    ...
    >
      ...
      >
        <div className="flex justify-between items-center">
          <h2 className="text-lg font-bold mb-6 uppercase">Cart ({totalQuantity})</h2>
        ...
        {cartItems.length === 0 ? (
          <p className='text-[#191919] font-bold text-center text-[18px]'>Your cart is empty.</p>
        ) : (
          <div className="mt-5">
            {cartItems.map(item => (
            ...
            <div className="mt-8 flex justify-center gap-4 items-center">
              ...
              <h3 className="text-[#191919] font-bold text-[18px]">$ {totalPrice}</h3>
            </div>
